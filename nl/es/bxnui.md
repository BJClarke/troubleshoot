...
Vuelva a intentarlo más tarde. Si vuelve a ver este mensaje, vaya a la [página de estado de {{site.data.keyword.Bluemix_notm}}](https://developer.ibm.com/bluemix/support/#status){: new_window} para comprobar si el servicio o el componente tienen algún problema. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Vuelva a intentarlo más tarde. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
En el Panel de control, pulse **Crear un espacio**. Cuando se cree el espacio, vuélvalo a intentar. Para obtener más instrucciones para solucionar este problema, consulte este [tema de resolución de problemas](https://www.{DomainName}/docs/troubleshoot/ts_accounts.html#ts_no_space){: new_window}.
...
Intente utilizar un nombre distinto o vuelva a intentarlo más tarde. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Vuelva al panel de control e inténtelo de nuevo. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Intente volver a revocar el acceso. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Para resolver este problema, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Vuelva a intentarlo más tarde. Si el problema continúa, vaya a <a href='http://ibm.biz/bluemixsupport' target='_blank'>Soporte de {{site.data.keyword.Bluemix_notm}}</a>.
...
Inténtelo de nuevo más tarde o vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Vuelva a intentarlo más tarde. Si vuelve a ver este mensaje, vaya a la [página de estado de {{site.data.keyword.Bluemix_notm}}](https://developer.ibm.com/bluemix/support/#status){: new_window} para comprobar si el servicio o el componente tienen algún problema. O bien, para obtener instrucciones para solucionar este problema, consulte este [tema de resolución de problemas](https://www.{DomainName}/docs/troubleshoot/ts_apps.html#ts_retrieve_space){: new_window}.
...
**Mensaje**: El intento para crear un registro ha fallado porque no tiene autorización sobre el espacio de nombres de registro para la org __nombreOrg__. El rol de usuario del desarrollador es obligatorio para crear un registro.
...
Vuelva a intentarlo más tarde. Si vuelve a ver este mensaje, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Inténtelo de nuevo. Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
## BXNUI2099E
**Mensaje**: La facturación del servicio {{site.data.keyword.Bluemix_notm}} ha emitido una excepción inesperada con este mensaje: "{0}"
...
## BXNUI2102E
**Mensaje**: Mensaje de facturación de servicio de {{site.data.keyword.Bluemix_notm}}: "{0}"
...
Cierre la sesión, inicie la sesión de nuevo y vuélvalo a intentar.  Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3016E
**Mensaje**: El contenedor no existe. Es posible que se haya suprimido.

Compruébelo y vuelva a intentarlo.  Si el problema continúa, vaya a [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
...
Inténtelo de nuevo. Si vuelve a ver este mensaje, póngase en contacto con el [Soporte de {{site.data.keyword.Bluemix_notm}}](http://ibm.biz/bluemixsupport){: new_window}.
