...
**Hinweis:** Falls Sie Ihre IBMid direkt über IBMid erstellt haben, erhalten Sie zwei E-Mails, die Sie verarbeiten müssen. Eine E-Mail stammt von der IBMid-Registrierung, die andere von {{site.data.keyword.Blu_full}}. Stellen Sie sicher, dass Sie die Aktionen ausführen, die in den beiden E-Mails aufgeführt sind.
