...
## BXNUI0016E
**Nachricht**: Die Apps und Services wurden nicht abgerufen, da eine Bluemix-Seite nicht geladen wurde. 
...
## BXNUI0064E
**Nachricht**: Der von Ihnen verwendete Browser wird von IBM Bluemix nicht unterstützt. 
...
Details hierzu finden Sie in der [Liste der Voraussetzungen](https://www.{DomainName}/docs/overview/prereqs.html#browsers){: new_window}.
...
Wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.
...
## BXNUI0082E
**Nachricht**: Ihre Benachrichtigungsvorgaben können von Bluemix derzeit nicht geladen werden.
...
Versuchen Sie es mit einem anderen Namen oder wiederholen Sie den Vorgang zu einem späteren Zeitpunkt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.
...
Kehren Sie zum Dashboard zurück und wiederholen Sie den Vorgang. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.
...
Versuchen Sie erneut, den Zugriff zu widerrufen. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.
...
Möglicherweise ist Ihr Bluemix-Konto abgelaufen oder es wurde storniert oder Sie wurden aus Ihrer Organisation entfernt. Wenden Sie sich an den zuständigen Organisationsmanager. Hilfe und Unterstützungsoptionen finden Sie im Abschnitt zur Fehlerbehebung in der Bluemix-Dokumentation.
...
Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den <a href='http://ibm.biz/bluemixsupport' target='_blank'>IBM Bluemix Support</a>.
...
**Nachricht**: Die Infrastrukturressourcen wurden nicht abgerufen, da beim Kontaktieren von SoftLayer ein Problem auftrat.
...
Wiederholen Sie den Vorgang. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.
...
## BXNUI2025E 
**Nachricht**: Bei dem Versuch, einen Entitätstag für Web-Caching zu erstellen, ist ein Fehler aufgetreten. IBM Bluemix konnte nicht feststellen, ob ein Symbol im Cache gespeichert wurde. 
...
## BXNUI2031E
**Nachricht**: Die Bluemix-Datenspeicherkomponente ist nicht verfügbar. 
...
## BXNUI2054E
**Nachricht**: Bluemix erfordert eine Berechtigung mit dem Geltungsbereich {0}. 
...
Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.
...
## BXNUI2099E
**Nachricht**: Die Bluemix-Serviceabrechnung hat eine unerwartete Ausnahmebedingung mit der folgenden Nachricht ausgegeben: "{0}"
...
## BXNUI2102E
**Nachricht**: Nachricht der Bluemix-Serviceabrechnung: "{0}"
...
**Nachricht**: Das Clientzertifikat ist noch nicht gültig. Es wird gültig ab {0}. 
...
## BXNUI3001E 
**Nachricht**: Die Operation zum Stoppen der Containerinstanz hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3002E 
**Nachricht**: Die Operation zum erneuten Starten der Containerinstanz hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3003E 
**Nachricht**: Die Operation zum Anhalten der Containerinstanz hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3004E 
**Nachricht**: Die Operation zum Fortsetzen der Containerinstanz hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3005E 
**Nachricht**: Die Operation zum Löschen der Containerinstanz hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3006E 
**Nachricht**: Bei der Operation zum Starten der Containerinstanz ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3007E 
**Nachricht**: Bei der Operation zum Stoppen der Containerinstanz ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3008E 
**Nachricht**: Bei der Operation zum erneuten Starten der Containerinstanz ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3009E 
**Nachricht**: Bei der Operation zum Anhalten der Containerinstanz ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3010E 
**Nachricht**: Bei der Operation zum Fortsetzen der Containerinstanz ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3011E 
**Nachricht**: Bei der Operation zum Löschen der Containerinstanz ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3012E 
**Nachricht**: Beim erneuten Starten des Containers ist ein Fehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3013E 
**Nachricht**: Beim Anhalten des Containers ist ein Fehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3014E 
**Nachricht**: Beim Fortsetzen des Containers ist ein Fehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.
	
## BXNUI3015E 
**Nachricht**: Es ist ein Authentifizierungsproblem aufgetreten. 

Melden Sie sich ab und anschließend wieder an und versuchen Sie es erneut.  Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3016E 
**Nachricht**: Der Container ist nicht vorhanden. Er wurde möglicherweise gelöscht. 

Prüfen Sie dies und wiederholen Sie den Vorgang.  Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3017E 
**Nachricht**: Beim Herstellen einer Verbindung zu IBM Containers ist ein Problem aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3018E 
**Nachricht**: Beim Stoppen des Containers ist ein Fehler aufgetreten; der Container befindet sich nun in einem Konflikt.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3050E 
**Nachricht**: Die Operation zum Starten der Instanz des virtuellen Servers hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3051E 
**Nachricht**: Die Operation zum Stoppen der Instanz des virtuellen Servers hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3052E 
**Nachricht**: Die Operation zum Fortsetzen der Instanz des virtuellen Servers hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3053E 
**Nachricht**: Die Operation zum Aussetzen der Instanz des virtuellen Servers hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3054E 
**Nachricht**: Die Operation zum Neustart der Instanz des virtuellen Servers hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3055E 
**Nachricht**: Die Operation zum Löschen der Instanz des virtuellen Servers hat das zulässige Zeitlimit überschritten.

Versuchen Sie es später erneut. Wird diese Nachricht erneut angezeigt, rufen Sie die [Bluemix-Statusseite](https://developer.ibm.com/bluemix/support/#status){: new_window} auf, um zu prüfen, ob für einen Service oder eine Komponente ein Problem vorliegt. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3056E 
**Nachricht**: Bei der Operation zum Starten der Instanz des virtuellen Servers ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3057E 
**Nachricht**: Bei der Operation zum Stoppen der Instanz des virtuellen Servers ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3058E 
**Nachricht**: Bei der Operation zum Fortsetzen der Instanz des virtuellen Servers ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3059E 
**Nachricht**: Bei der Operation zum Aussetzen der Instanz des virtuellen Servers ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3060E 
**Nachricht**: Bei der Operation zum Neustart der Instanz des virtuellen Servers ist ein Verbindungsfehler aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3061E 
**Nachricht**: Bei der Operation zum Löschen der Instanz des virtuellen Servers ist ein Verbindungsfehler aufgetreten.
...
## BXNUI3063E 
**Nachricht**: Der virtuelle Server ist nicht vorhanden. 
...
## BXNUI3064E 
**Nachricht**: Es ist ein Fehler aufgetreten; die Instanz des virtuellen Servers befindet sich nun in einem Konflikt.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3065E 
**Nachricht**: Beim Herstellen einer Verbindung zu IBM Virtual Servers ist ein Problem aufgetreten.

Versuchen Sie es später erneut. Wenn das Problem bestehen bleibt, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3066E 
**Nachricht**: Der Versuch, die App zu migrieren, ist fehlgeschlagen, da Cloud Foundry die App nicht auf Diego umstellen konnte.

Versuchen Sie es später erneut. Wenn diese Nachricht erneut angezeigt wird, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3067E 
**Nachricht**: Der Versuch, die App auf DEA zurückzusetzen, ist fehlgeschlagen, da kein Kontakt zu Cloud Foundry hergestellt werden konnte.

Wiederholen Sie den Vorgang. Wenn diese Nachricht erneut angezeigt wird, wenden Sie sich an den [IBM Bluemix Support](http://ibm.biz/bluemixsupport){: new_window}.
