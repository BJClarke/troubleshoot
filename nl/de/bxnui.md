...
Wiederholen Sie den Vorgang zu einem späteren Zeitpunkt oder rufen Sie [{{site.data.keyword.Bluemix_notm}} Support](http://ibm.biz/bluemixsupport){: new_window} auf.
...
Wenn das Problem bestehen bleibt, wenden Sie sich an den [{{site.data.keyword.Bluemix_notm}} Support](http://ibm.biz/bluemixsupport){: new_window}.
...
Melden Sie sich ab und anschließend wieder an und versuchen Sie es erneut.  Wenn das Problem bestehen bleibt, wenden Sie sich an den [{{site.data.keyword.Bluemix_notm}} Support](http://ibm.biz/bluemixsupport){: new_window}.

## BXNUI3016E
**Nachricht**: Der Container ist nicht vorhanden. Er wurde möglicherweise gelöscht.

Prüfen Sie dies und wiederholen Sie den Vorgang.  Wenn das Problem bestehen bleibt, wenden Sie sich an den [{{site.data.keyword.Bluemix_notm}} Support](http://ibm.biz/bluemixsupport){: new_window}.
...
Wiederholen Sie den Vorgang. Wenn diese Nachricht erneut angezeigt wird, wenden Sie sich an den [{{site.data.keyword.Bluemix_notm}} Support](http://ibm.biz/bluemixsupport){: new_window}.
