...
## BXNUI2035E
 **메시지**: {1} 리소스가 삭제되지 않았습니다. 리소스를 삭제하기 위해 Cloud Foundry에 접속하는 중에 오류가 발생했습니다. Cloud Foundry 메시지: "{0}."
...
조직을 올바르게 지정했는지 확인하십시오. 이 메시지가 다시 나타나면 [{{site.data.keyword.Bluemix_notm}} 상태 페이지](https://developer.ibm.com/bluemix/support/#status){: new_window}로 이동하여 서비스 또는 컴포넌트에 문제가 있는지 여부를 확인하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.
...
문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.
...
## BXNUI2076E
**메시지**: 인증서가 아직 유효하지 않습니다. {0}에 유효하게 됩니다.

## BXNUI2077E
**메시지**: 인증서가 {0}에 만료되었습니다.

## BXNUI2078E
**메시지**: 중간 인증서가 아직 유효하지 않습니다. {0}에 유효하게 됩니다.

## BXNUI2079E
**메시지**: 중간 인증서가 {0}에 만료되었습니다.
...
## BXNUI2081E
**메시지**: 알 수 없는 오류가 발생하여 인증서 및 키가 수정되지 않았습니다: {0}

[{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI2082E
**메시지**: 문제점이 발생하여 업로드된 인증서의 컨텐츠를 읽지 못했습니다. {0}

[{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI2083E
**메시지**: 비즈니스 지원 시스템의 확장 요청을 완료할 수 없습니다.
...
## BXNUI2085E
**메시지**: 가격 책정 비용 정보를 구문 분석할 수 없습니다.
...
## BXNUI2087E
**메시지**: 앱 이름이 너무 깁니다. 이 앱 이름은 {0}자로 제한됩니다. 
...
로그아웃한 후에 로그인하고 다시 시도하십시오. 이 메시지가 다시 나타나면 [{{site.data.keyword.Bluemix_notm}} 상태 페이지](https://developer.ibm.com/bluemix/support/#status){: new_window}로 이동하여 서비스 또는 컴포넌트에 문제가 있는지 여부를 확인하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.
...
## BXNUI2090E
**메시지**: URL "{0}"에 템플리트를 등록하려는 시도가 실패했습니다. 템플리트의 컨텐츠가 잘못 구성되었습니다. 오류: "{1}"

[{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI2091E
**메시지**: "{1}" 오류로 인해 서비스 브로커 URL "{0}"에 연결하려는 시도가 실패했습니다.

[{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI2092E
**메시지**: URL "{0}"에서 서비스 브로커 카탈로그를 얻으려는 시도가 널을 리턴했습니다.
...
## BXNUI2100E
**메시지**: JazzHub가 "{0}" 메시지와 함께 예상치 못한 예외를 발행했습니다.

[{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI2101E
**메시지**: IBM DataPower가 "{0}" 메시지와 함께 예상치 못한 예외를 발행했습니다.

[{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI2102E
**메시지**: {{site.data.keyword.Bluemix_notm}} 서비스 청구 메시지: "{0}"
...
## BXNUI2104E
**메시지**: IBM DataPower 메시지: "{0}"

[{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI2105E
**메시지**: Cloud Foundry 연결 시도가 실패했습니다.
...
## BXNUI2109E
**메시지**: 사용자 ID("{0}")에 조직의 조직 관리자 역할이 지정되지 않아서 서비스 브로커가 작성되거나 업데이트되지 않았습니다.
...
**메시지**: 클라이언트 인증서가 아직 유효하지 않습니다. {0}에 유효하게 됩니다.

## BXNUI2112E

**메시지**: 클라이언트 인증서가 {0}에 만료되었습니다.

[{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI2113E

**메시지**: 사용자 플랫폼 환경 설정을 처리할 수 없습니다.
...
## BXNUI3007E
**메시지**: 컨테이너 인스턴스를 중지하는 오퍼레이션에 연결 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3008E
**메시지**: 컨테이너 인스턴스를 다시 시작하는 오퍼레이션에 연결 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3009E
**메시지**: 컨테이너 인스턴스를 일시정지하는 오퍼레이션에 연결 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3010E
**메시지**: 컨테이너 인스턴스를 일시정지 해제하는 오퍼레이션에 연결 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3011E
**메시지**: 컨테이너 인스턴스를 삭제하는 오퍼레이션에 연결 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3012E
**메시지**: 컨테이너를 다시 시작하는 중에 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3013E
**메시지**: 컨테이너를 일시정지하는 중에 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3014E
**메시지**: 컨테이너를 일시정지 해제하는 중에 오류가 발생했습니다.
...
로그아웃한 후에 로그인하고 다시 시도하십시오.  문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3016E
**메시지**: 컨테이너가 없습니다. 삭제되었을 수 있습니다.

확인하고 다시 시도하십시오.  문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3017E
**메시지**: IBM Containers에 접속하는 중에 문제점이 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3018E
**메시지**: 컨테이너를 중지할 때 오류가 발생했으며 이는 현재 충돌 상태입니다.
...
## BXNUI3057E
**메시지**: 가상 서버 인스턴스를 중지하는 오퍼레이션에 연결 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3058E
**메시지**: 가상 서버 인스턴스를 재개하는 오퍼레이션에 연결 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3059E
**메시지**: 가상 서버 인스턴스를 일시중단하는 오퍼레이션에 연결 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3060E
**메시지**: 가상 서버 인스턴스를 다시 부팅하는 오퍼레이션에 연결 오류가 발생했습니다.

나중에 다시 시도하십시오. 문제점이 지속되면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}으로 이동하십시오.

## BXNUI3061E
**메시지**: 가상 서버 인스턴스를 삭제하는 오퍼레이션에 연결 오류가 발생했습니다.
...
## BXNUI3064E
**메시지**: 오류가 발생했으며 가상 서버 인스턴스는 현재 충돌 상태입니다.
...
다시 시도하십시오.  이 메시지가 다시 나타나면 [{{site.data.keyword.Bluemix_notm}} 지원](http://ibm.biz/bluemixsupport){: new_window}에 문의하십시오.
