...
## 라이트 플랜 인스턴스를 작성할 수 없음
{: #nosecondlite}

라이트 플랜 인스턴스를 작성하려고 시도하면 다음과 같은 오류 메시지를 수신합니다.
{: tsSymptoms}
...
동일한 조직에서 작업할 사용자를 두 명 이상 초대할 수 있습니다. 계정 소유자이거나 조직의 관리자인 경우에만 조직에 사용자를 초대할 수 있습니다.
...
**참고:** 모든 조직 관리자는 이미 조직에 있는 사용자를 추가, 수정 및 제거할 수 있습니다.

조직에 사용자를 초대할 수 없는 경우 조직 관리자에게 문의하십시오. 조직 관리자를 확인하려면 다음 단계를 수행하십시오.
{: tsResolve}
